...
class Nativite extends StatefulWidget {
  const Nativite({Key? key}) : super(key: key);

  @override
  _NativiteState createState() => _NativiteState();
}

class _NativiteState extends State<Nativite> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset("${mydir?.path}/3-nativite.mp4",
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      MaterialButton(
                        color: colorPrimary,
                        onPressed: () {
                          Navigator.pushNamed(context, '/natitive_text');
                        },
                        child: Row(
                          children: [
